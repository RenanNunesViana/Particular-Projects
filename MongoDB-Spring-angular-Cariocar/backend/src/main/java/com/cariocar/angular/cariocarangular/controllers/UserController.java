...
public class UserController {
    ...
    public User createUser(@RequestBody UserDTO userDTO){
        User user = ConcreteFactory.createCliente(userDTO);
    ...
    public User showUser(@PathVariable ObjectId id){return userService.getById(id);}
    ...
    public void deleteUser(@PathVariable ObjectId id){userService.deleteUser(id);}

    @PutMapping(value = "/{id}")
    @ResponseStatus(HttpStatus.ACCEPTED)
    public User editUser(@PathVariable Long id, @RequestBody User user){return userService.editUser(user);}
}
